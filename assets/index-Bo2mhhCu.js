import{d as St,s as _t,f as Et,g as Ct,o as c,c as h,a as r,x as at,h as u,F as B,j as rt,n as nt,t as l,k as At,i as F,z as It,m as Ft,A as Tt,B as Lt,T as zt,r as f,p as Vt,w as Bt,q as qt}from"./index-DRUfDUqf.js";import{W as $t}from"./WorkbookImportPanel-D5qxqg-K.js";import{d as Nt,u as Mt}from"./useInventoryWorkbookSource-DxV-8tJp.js";import{_ as Rt}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./businessDataStore-KowC_G3t.js";const Wt={class:"page-container expiry-dashboard-page"},jt={class:"batch-pagination","aria-label":"批次与效期预警页面"},Ht={class:"batch-tab-list",role:"tablist"},Ot=["id","aria-selected","onClick"],Pt={class:"batch-page-controls"},Qt=["disabled"],Ut=["disabled"],Kt={class:"dashboard-frame-shell"},Gt={key:0,class:"frame-loading"},Yt=["src"],Jt={class:"detail-dialog-header"},Xt={class:"detail-dialog-summary"},Zt={class:"detail-dialog-table-wrap"},te={class:"detail-dialog-table"},ee={class:"code-cell"},ae={class:"material-cell"},re={class:"code-cell"},ne={class:"number-cell"},oe={class:"number-cell"},ie={class:"number-cell"},le={key:0},ot="chart-detail-dialog-title",q=1.1,se=`
  :root {
