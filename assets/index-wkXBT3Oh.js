...
`,ma=ne({__name:"index",setup(u){const l=k(!0),p=k(),S=k(900),y=k("risk"),c=k(null),m=k(),h=k(0),v=ue();he();function B(t){return t==="material"?"material":"raw"}const F=k(B(v.params.type)),L=R(()=>F.value==="raw"?"原料":"物料"),D=k(null),M=R(()=>Ie(D.value)),V=k(!1),P=k(""),rt=k(null),ot=R(()=>{var t;return Ce(((t=D.value)==null?void 0:t.records)||[])}),K=k([]);function _t(t){return ot.value.get(t)||[]}async function Ct(){try{D.value=await Be()}catch{D.value=null}}async function At(t){V.value=!0,P.value="";try{D.value=await Ae(t)}catch(e){P.value=e instanceof Error?e.message:"BOM 文件导入失败"}finally{V.value=!1}}async function Bt(){try{await Ne(),D.value=null}catch{}}function Nt(){var t;(t=rt.value)==null||t.click()}async function It(t){var r;const e=t.target,a=(r=e.files)==null?void 0:r[0];a&&(await At(a),e.value="")}function it(t){return t===null?"missing":t<0?"expired":t<=30?"red":t<=90?"yellow":"green"}function Ft(t){const e=it(t);return{expired:"已过期",red:"红灯",yellow:"黄灯",green:"绿灯",missing:"效期待补充"}[e]||"—"}function Lt(t){return(t||0).toLocaleString("zh-CN",{maximumFractionDigits:0})}function Mt(t){return((t||0)/1e4).toLocaleString("zh-CN",{minimumFractionDigits:2,maximumFractionDigits:2})}const Y=R(()=>{if(!D.value||!ot.value.size)return[];const t=new Set,e=[];for(const a of K.value){if(a.remDays===null||a.remDays>90)continue;const r=_t(a.mat);if(r.length===0)continue;const o=`${a.mat}-${a.batch}`;t.has(o)||(t.add(o),e.push({mat:a.mat,sku:a.sku,batch:a.batch,category:a.category,expDate:a.expDate,remDays:a.remDays,endQty:a.endQty,endAmt:a.endAmt,flavors:r,state:it(a.remDays)}))}return e.sort((a,r)=>{const o=a.remDays??9999,i=r.remDays??9999;return o-i||r.endAmt-a.endAmt})}),z=[{id:"risk",label:"库存风险"},{id:"stagnant",label:"库存积压"},{id:"replenishment",label:"补货预警"},{id:"trafficLight",label:"红黄灯"}],st=R(()=>z.findIndex(t=>t.id===y.value));let _,C,$,G,J="";const Z=[],{sourceUrl:lt,sourceMeta:O,importing:Tt,importError:zt,initialize:$t,importFile:qt,reset:Rt,setMaterialType:Vt,dispose:Pt}=fe({initialMaterialType:B(v.params.type)}),Ot={已过期:t=>t.remDays!==null&&t.remDays<0,"0-30天":t=>t.remDays!==null&&t.remDays>=0&&t.remDays<=30,"31-90天":t=>t.remDays!==null&&t.remDays>=31&&t.remDays<=90,"91-180天":t=>t.remDays!==null&&t.remDays>=91&&t.remDays<=180,"181-365天":t=>t.remDays!==null&&t.remDays>=181&&t.remDays<=365,"1年以上":t=>t.remDays!==null&&t.remDays>365};function ct(t){return new Intl.NumberFormat("zh-CN",{maximumFractionDigits:2}).format(t||0)}function dt(t){return new Intl.NumberFormat("zh-CN",{minimumFractionDigits:2,maximumFractionDigits:2}).format(t||0)}function Wt(t){return t===null?"is-neutral":t<0?"is-expired":t<=30?"is-critical":t<=90?"is-warning":"is-normal"}function T(){var t;return(t=p.value)==null?void 0:t.contentWindow}function ut(t){return t<=0?t:Math.max(Math.round(t*nt),Math.ceil(t+1))}function pt(t){return t.replace(/(\d+(?:\.\d+)?)px/g,(e,a)=>`${ut(Number(a))}px`)}function mt(t){Array.from(t).forEach(e=>{if(e.type===CSSRule.STYLE_RULE){const r=e.style;r.fontSize&&(r.fontSize=pt(r.fontSize))}const a=e.cssRules;a&&mt(a)})}function Ht(t){const e=t.documentElement;e.dataset.systemFontScaleApplied!==String(nt)&&(Array.from(t.styleSheets).forEach(a=>{try{mt(a.cssRules)}catch{}}),t.querySelectorAll("[style]").forEach(a=>{a.style.fontSize&&(a.style.fontSize=pt(a.style.fontSize))}),e.dataset.systemFontScaleApplied=String(nt))}function W(t,e="",a=new WeakMap){if(typeof t=="number"&&e==="fontSize")return ut(t);if(!t||typeof t!="object")return t;if(a.has(t))return a.get(t);if(Array.isArray(t)){const o=[];return a.set(t,o),t.forEach(i=>o.push(W(i,"",a))),o}const r={};return a.set(t,r),Object.entries(t).forEach(([o,i])=>{r[o]=W(i,o,a)}),r}function ht(t){var r;if(t.__systemFontScaleApplied||!t.setOption)return;const e=t.setOption.bind(t);t.setOption=(o,...i)=>{e(W(o),...i)},t.__systemFontScaleApplied=!0;const a=(r=t.getOption)==null?void 0:r.call(t);a&&e(W(a))}function bt(t){var a;const e=(a=T())==null?void 0:a.echarts;if(e){if(!e.__systemFontScaleApplied&&e.init){const r=e.init.bind(e);e.init=(...o)=>{const i=r(...o);return ht(i),i},e.__systemFontScaleApplied=!0}t.querySelectorAll(".chart-box").forEach(r=>{const o=e.getInstanceByDom(r);o&&ht(o)})}}function ft(){const t=T();if(!t)return[];try{return t.eval("getView()")}catch{return[]}}function jt(t,e,a){const r=[...a].sort((o,i)=>o.remDays===null?1:i.remDays===null?-1:o.remDays-i.remDays);c.value={title:t,description:e,rows:r,totalQuantity:r.reduce((o,i)=>o+(i.endQty||0),0),totalAmount:r.reduce((o,i)=>o+(i.endAmt||0),0)},me(()=>{var o;return(o=m.value)==null?void 0:o.focus()})}function tt(){c.value=null}function H(t,e,a,r){var w,N,Q;const o=t.getElementById(e),i=o&&((N=(w=T())==null?void 0:w.echarts)==null?void 0:N.getInstanceByDom(o));if(!o||!i)return;o.classList.add("drillable-chart");const d=(Q=o.closest(".card"))==null?void 0:Q.querySelector(".card-title");if(d&&!d.querySelector(".drill-hint")){const x=t.createElement("span");x.className="drill-hint",x.textContent="点击图形查看明细",d.appendChild(x)}const f=x=>{const q=r(x,ft());jt(a,q.description,q.rows)};i.on("click",f),Z.push(()=>i.off("click",f))}function Qt(t){Z.splice(0).forEach(e=>e()),H(t,"chart-expiry","效期区间批次明细",(e,a)=>{const r=Ot[e.name]??(()=>!1);return{description:`效期区间：${e.name} · 数据继承当前页面筛选条件`,rows:a.filter(r)}}),H(t,"chart-warehouse","零耗用物料明细",(e,a)=>({description:`品类：${e.name} · 实际耗用量为 0`,rows:a.filter(r=>r.category===e.name&&r.consume===0)})),H(t,"chart-category","品类风险批次明细",(e,a)=>{var i;const r=T();let o="";try{const d=r==null?void 0:r.eval("computeCategory(getView())");o=((i=d==null?void 0:d[e.dataIndex])==null?void 0:i.category)??""}catch{o=e.name.split(" ")[0]}return{description:`品类：${o} · 临期及过期批次（剩余天数 ≤ 90 天）`,rows:a.filter(d=>d.category===o&&d.remDays!==null&&d.remDays<=90)}}),H(t,"chart-supplier","供应商风险批次明细",(e,a)=>({description:`供应商：${e.name} · 临期及过期批次（剩余天数 ≤ 90 天）`,rows:a.filter(r=>r.supplier===e.name&&r.remDays!==null&&r.remDays<=90)}))}const Xt={risk:[".dashboard > .charts-row"],stagnant:[".dashboard > .rank-row"],replenishment:[".dashboard > section.card:not(.rules-row)",".dashboard > .rules-row"],trafficLight:[".dashboard > .traffic-light-row"]},Ut=[".dashboard > .charts-row",".dashboard > .rank-row",".dashboard > section.card:not(.rules-row)",".dashboard > .rules-row",".dashboard > .traffic-light-row"].join(", ");function j(){$&&(window.clearTimeout(G),G=window.setTimeout(()=>{$&&(S.value=Math.max(900,Math.ceil($.scrollHeight)+2))},40))}function Kt(t){var a;const e=(a=T())==null?void 0:a.echarts;e&&t.querySelectorAll(".chart-box").forEach(r=>{var o,i;r.offsetParent!==null&&((i=(o=e.getInstanceByDom(r))==null?void 0:o.resize)==null||i.call(o))})}function Yt(t,e){const a=t.querySelector(".system-batch-pagination");if(a)return a;e.id||(e.id="embedded-expiry-dashboard");const r=t.createElement("nav");r.className="system-batch-pagination",r.setAttribute("aria-label","批次与效期预警页面");const o=t.createElement("div");o.className="system-batch-tab-list",o.setAttribute("role","tablist"),z.forEach((N,Q)=>{const x=t.createElement("button"),q=t.createElement("span");x.id=`embedded-batch-tab-${N.id}`,x.type="button",x.dataset.dashboardView=N.id,x.setAttribute("role","tab"),x.setAttribute("aria-controls",e.id),q.textContent=String(Q+1).padStart(2,"0"),x.append(q,t.createTextNode(N.label)),x.addEventListener("click",()=>yt(N.id)),o.appendChild(x)});const i=t.createElement("div");i.className="system-batch-page-controls";const d=t.createElement("span");d.dataset.pageStatus="true";const f=t.createElement("button");f.type="button",f.dataset.pageDirection="previous",f.setAttribute("aria-label","上一页"),f.textContent="←",f.addEventListener("click",()=>vt(-1));const w=t.createElement("button");return w.type="button",w.dataset.pageDirection="next",w.setAttribute("aria-label","下一页"),w.textContent="→",w.addEventListener("click",()=>vt(1)),i.append(d,f,w),r.append(o,i),r}function Gt(t,e){const a=e.querySelector(":scope > .kpi-row"),r=e.querySelector(":scope > .header"),o=e.querySelector(":scope > .upload-hint"),i=Yt(t,e);let d=null;a&&(e.insertBefore(a,e.firstElementChild),d=a),[r,o,i].forEach(f=>{f&&(d?d.after(f):e.insertBefore(f,e.firstElementChild),d=f)})}function Jt(t){const e=st.value;t.querySelectorAll("[data-dashboard-view]").forEach(i=>{const d=i.dataset.dashboardView===y.value;i.classList.toggle("active",d),i.setAttribute("aria-selected",String(d)),i.tabIndex=d?0:-1});const a=t.querySelector("[data-page-status]");a&&(a.textContent=`${String(e+1).padStart(2,"0")} / ${String(z.length).padStart(2,"0")}`);const r=t.querySelector('[data-page-direction="previous"]'),o=t.querySelector('[data-page-direction="next"]');r&&(r.disabled=e===0),o&&(o.disabled=e===z.length-1)}function gt(t){t.querySelectorAll(Ut).forEach(e=>{e.classList.add("system-pagination-hidden"),e.setAttribute("aria-hidden","true")}),Xt[y.value].forEach(e=>{t.querySelectorAll(e).forEach(a=>{a.classList.remove("system-pagination-hidden"),a.setAttribute("aria-hidden","false")})}),t.documentElement.dataset.systemDashboardView=y.value,Jt(t),requestAnimationFrame(()=>{Kt(t),j()})}function yt(t){var a;if(y.value===t)return;y.value=t;const e=(a=p.value)==null?void 0:a.contentDocument;e&&gt(e)}function vt(t){const e=st.value+t,a=z[e];a&&yt(a.id)}function Zt(){var o,i,d,f;l.value=!1;const t=ft();h.value=t.length,K.value=t;const e=(o=p.value)==null?void 0:o.contentDocument;if(!e)return;if(!e.getElementById("system-minimal-theme")){const w=e.createElement("style");w.id="system-minimal-theme",w.textContent=pa,e.head.appendChild(w)}Ht(e),bt(e),(d=(i=T())==null?void 0:i.renderAll)==null||d.call(i),bt(e),Qt(e);const a=e.querySelector(".dashboard > section.card:not(.rules-row)");(f=a==null?void 0:a.lastElementChild)==null||f.classList.add("batch-detail-scroll");const r=e.querySelector(".dashboard");r&&($=r,Gt(e,r),gt(e),_==null||_.disconnect(),C==null||C.disconnect(),_=new ResizeObserver(j),C=new MutationObserver(j),_.observe(r),C.observe(r,{childList:!0,subtree:!0,characterData:!0}),requestAnimationFrame(j))}function te(){l.value=!1,h.value=0,K.value=[]}async function ee(t){try{await qt(t),l.value=!0,h.value=0,c.value=null}catch{}}async function ae(){try{await Rt(),l.value=!0,h.value=0,c.value=null}catch{}}function xt(t){t.key==="Escape"&&c.value&&tt()}return wt(c,t=>{t?(J=document.body.style.overflow,document.body.style.overflow="hidden"):document.body.style.overflow=J}),wt(()=>v.params.type,t=>{const e=B(t);F.value!==e&&(F.value=e,l.value=!0,h.value=0,c.value=null,Vt(e))}),re(()=>{$t(),Ct(),document.documentElement.classList.add("batch-bento-active"),window.addEventListener("keydown",xt)}),oe(()=>{Pt(),Z.splice(0).forEach(t=>t()),_==null||_.disconnect(),C==null||C.disconnect(),$=void 0,window.clearTimeout(G),window.removeEventListener("keydown",xt),document.body.style.overflow=J,document.documentElement.classList.remove("batch-bento-active")}),(t,e)=>(b(),g(X,null,[n("div",Fe,[n("input",{ref_key:"bomFileInput",ref:rt,type:"file",accept:".xlsx,.xls",class:"hidden-bom-input",onChange:It},null,544),n("div",Le,[kt(be,{title:"批次与效期数据",description:"导入库存 Excel 后，效期区间、呆滞库存和补货建议将按新批次数据重算","file-name":E(O).fileName,"updated-at":E(O).updatedAt,"row-count":h.value||E(O).rowCount,busy:E(Tt),custom:E(O).isCustom,error:E(zt),"action-label":"导入库存 Excel","show-template":"",onFile:ee,onReset:ae,onTemplate:E(ge)},null,8,["file-name","updated-at","row-count","busy","custom","error","onTemplate"]),n("section",Me,[n("div",Te,[e[0]||(e[0]=n("span",{class:"panel-kicker"},"BOM DATA",-1)),e[1]||(e[1]=n("strong",null,"配方耗用关联",-1)),M.value.isCustom?(b(),g("p",ze,s(M.value.fileName)+" · "+s(M.value.rowCount)+" 条 · "+s(M.value.updatedAt.slice(0,10)),1)):(b(),g("p",$e,"上传 BOM 文件后，临期"+s(L.value)+"可显示可耗用口味，提前预警减少报废",1)),P.value?(b(),g("p",qe,s(P.value),1)):A("",!0)]),n("div",Re,[n("button",{type:"button",class:"btn btn-primary",disabled:V.value,onClick:Nt},s(V.value?"上传中...":"上传 BOM Excel"),9,Ve),M.value.isCustom?(b(),g("button",{key:0,type:"button",class:"btn btn-secondary",onClick:Bt}," 清除 BOM ")):A("",!0)])])]),n("div",Pe,[l.value?(b(),g("div",Oe,"正在载入"+s(L.value)+"批次与效期预警看板...",1)):A("",!0),E(lt)?(b(),g("iframe",{key:1,id:"expiry-dashboard-frame",ref_key:"dashboardFrame",ref:p,class:"expiry-dashboard-frame",src:E(lt),title:`${L.value}批次与效期预警看板`,scrolling:"no",style:ie({height:`${S.value}px`}),onLoad:Zt,onError:te},null,44,We)):A("",!0)]),M.value.isCustom&&Y.value.length?(b(),g("section",He,[n("div",je,[n("div",null,[e[2]||(e[2]=n("span",{class:"panel-kicker"},"FLAVOR EXPIRY ALERT",-1)),n("h2",null,"临期"+s(L.value)+"耗用预警",1)]),n("span",Qe,s(Y.value.length)+" 条临期"+s(L.value)+"可在 BOM 配方中耗用 · 按剩余天数升序 ",1)]),n("div",Xe,[n("table",Ue,[e[3]||(e[3]=n("thead",null,[n("tr",null,[n("th",null,"物料"),n("th",null,"批次"),n("th",{class:"number-cell"},"库存数量"),n("th",{class:"number-cell"},"库存金额"),n("th",null,"到期日期"),n("th",null,"剩余天数"),n("th",null,"效期状态"),n("th",null,"可耗用口味")])],-1)),n("tbody",null,[(b(!0),g(X,null,et(Y.value,(a,r)=>(b(),g("tr",{key:`${a.mat}-${a.batch}-${r}`},[n("td",Ke,[n("strong",null,s(a.sku||"未标注物料"),1),n("span",null,s(a.mat),1)]),n("td",null,s(a.batch||"—"),1),n("td",Ye,s(Lt(a.endQty)),1),n("td",Ge,s(Mt(a.endAmt))+" 万元",1),n("td",null,[n("strong",null,s(a.expDate||"未标注"),1)]),n("td",null,[n("span",{class:at(["rem-days-badge",a.state])},s(a.remDays!==null?`${a.remDays} 天`:"—"),3)]),n("td",null,[n("span",{class:at(["expiry-status-badge",a.state])},s(Ft(a.remDays)),3)]),n("td",Je,[a.flavors.length?A("",!0):(b(),g("span",Ze,"—")),(b(!0),g(X,null,et(a.flavors,o=>(b(),g("span",{key:o.flavor,class:"flavor-tag",title:o.blendingName?`调配液：${o.blendingName}`:""},s(o.flavor),9,ta))),128))])]))),128))])])])])):A("",!0)]),(b(),se(de,{to:"body"},[kt(ce,{name:"detail-dialog"},{default:le(()=>[c.value?(b(),g("div",{key:0,class:"detail-dialog-backdrop",role:"presentation",onMousedown:pe(tt,["self"])},[n("section",{class:"detail-dialog",role:"dialog","aria-modal":"true","aria-labelledby":St},[n("header",ea,[n("div",null,[e[4]||(e[4]=n("p",{class:"detail-dialog-eyebrow"},"CHART DETAIL · 图表下钻",-1)),n("h2",{id:St},s(c.value.title),1),n("p",null,s(c.value.description),1)]),n("button",{ref_key:"dialogCloseButton",ref:m,type:"button",class:"detail-dialog-close","aria-label":"关闭明细弹窗",onClick:tt}," × ",512)]),n("div",aa,[n("div",null,[e[5]||(e[5]=n("span",null,"命中记录",-1)),n("strong",null,s(c.value.rows.length),1),e[6]||(e[6]=n("small",null,"条",-1))]),n("div",null,[e[7]||(e[7]=n("span",null,"库存数量",-1)),n("strong",null,s(ct(c.value.totalQuantity)),1),e[8]||(e[8]=n("small",null,"KG",-1))]),n("div",null,[e[9]||(e[9]=n("span",null,"库存金额",-1)),n("strong",null,s(dt(c.value.totalAmount)),1),e[10]||(e[10]=n("small",null,"元",-1))])]),n("div",na,[n("table",ra,[e[12]||(e[12]=n("thead",null,[n("tr",null,[n("th",null,"物料编码"),n("th",null,"物料描述"),n("th",null,"批次"),n("th",null,"品类"),n("th",null,"供应商"),n("th",{class:"number-cell"},"库存数量"),n("th",{class:"number-cell"},"库存金额"),n("th",null,"生产日期"),n("th",null,"到期日期"),n("th",{class:"number-cell"},"剩余天数"),n("th",null,"建议动作")])],-1)),n("tbody",null,[(b(!0),g(X,null,et(c.value.rows,(a,r)=>(b(),g("tr",{key:`${a.mat}-${a.batch}-${r}`},[n("td",oa,s(a.mat||"—"),1),n("td",ia,s(a.sku||"—"),1),n("td",sa,s(a.batch||"—"),1),n("td",null,s(a.category||"未知"),1),n("td",null,s(a.supplier||"未知"),1),n("td",la,s(ct(a.endQty)),1),n("td",ca,s(dt(a.endAmt)),1),n("td",null,s(a.prodDate||"—"),1),n("td",null,s(a.expDate||"—"),1),n("td",da,[n("span",{class:at(["days-value",Wt(a.remDays)])},s(a.remDays??"—"),3)]),n("td",null,s(a.action||"—"),1)]))),128)),c.value.rows.length===0?(b(),g("tr",ua,[...e[11]||(e[11]=[n("td",{colspan:"11",class:"detail-empty"},"当前条件下没有可显示的批次明细",-1)])])):A("",!0)])])])])],32)):A("",!0)]),_:1})]))],64))}}),va=Se(ma,[["__scopeId","data-v-67665bbe"]]);export{va as default};
