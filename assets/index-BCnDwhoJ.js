import{d as qt,r as v,g as K,f as Vt,h as Pt,o as c,c as d,a as n,t as s,j as D,i as ht,B as Rt,F as T,k as X,m as G,x as Wt,z as Ht,C as Ot,D as Qt,T as jt,J as Ut,y as C,w as Kt,n as Xt,u as Gt}from"./index-DbQroGWC.js";import{u as Jt,e as Yt}from"./useInventoryWorkbookSource-BuA7WWp_.js";import{g as Zt}from"./businessDataStore-BwGRYbGU.js";import{_ as te}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./xlsx-CuKvrqns.js";function ee(g){return String(g??"").replace(/\s+/g," ").trim()}function ae(g){let u=ee(g);return u?(u=u.replace(/^(PET瓶|HDPE瓶|PP瓶|PET|HDPE|TP|PP|PC|PE|瓶)/i,""),u=u.replace(/[（(].*$/,""),u=u.replace(/(调配液|浓缩液|原浆|糖浆|调配|浓缩|液)$/i,""),u.trim()):""}function ne(g){const u=new Map;return g.forEach(y=>{if(!y.materialCode)return;const A=y.flavor||ae(y.blendingName);if(!A)return;const h=u.get(y.materialCode)||[],p={flavor:A,blendingName:y.blendingName};h.some(S=>S.flavor===p.flavor&&S.blendingName===p.blendingName)||h.push(p),u.set(y.materialCode,h)}),u}function re(){return Zt("bom")}function ie(g){return g?{fileName:g.fileName,updatedAt:g.updatedAt,rowCount:g.records.length,isCustom:!0}:{fileName:"",updatedAt:"",rowCount:0,isCustom:!1}}const oe={class:"page-container expiry-dashboard-page"},se={class:"dashboard-frame-shell"},le={key:0,class:"frame-loading"},ce=["src","title"],de={key:0,class:"flavor-warning-panel"},ue={key:0,class:"flavor-warning-empty"},pe={class:"flavor-warning-heading"},me={key:0,class:"flavor-warning-meta"},he={key:0,class:"flavor-warning-empty"},be={key:1,class:"flavor-warning-table-wrap"},fe={class:"flavor-warning-table"},ge={class:"flavor-material-cell"},ye={class:"number-cell"},ve={class:"number-cell"},xe={class:"flavor-cell"},ke={key:0,class:"flavor-empty"},we=["title"],De={class:"detail-dialog-header"},Se={class:"detail-dialog-summary"},Ee={class:"detail-dialog-table-wrap"},_e={class:"detail-dialog-table"},Ce={class:"code-cell"},Ae={class:"material-cell"},Fe={class:"code-cell"},Be={class:"number-cell"},Le={class:"number-cell"},Ne={class:"number-cell"},Te={key:0},bt="chart-detail-dialog-title",J=1.1,ze=`
  :root {
...
`,Me=qt({__name:"index",setup(g){const u=v(!0),y=v(),A=v(900),h=v("risk"),p=v(null),R=v(),S=v(0),W=Ut();Gt();function H(t){return t==="material"?"material":"raw"}const z=v(H(W.params.type)),F=C(()=>z.value==="raw"?"原料":"物料"),B=v(null),ft=C(()=>ie(B.value)),Y=C(()=>{var t;return ne(((t=B.value)==null?void 0:t.records)||[])}),M=v([]);function gt(t){return Y.value.get(t)||[]}async function yt(){try{B.value=await re()}catch{B.value=null}}function Z(t){return t===null?"missing":t<0?"expired":t<=30?"red":t<=90?"yellow":"green"}function vt(t){const e=Z(t);return{expired:"已过期",red:"红灯",yellow:"黄灯",green:"绿灯",missing:"效期待补充"}[e]||"—"}function xt(t){return(t||0).toLocaleString("zh-CN",{maximumFractionDigits:0})}function kt(t){return((t||0)/1e4).toLocaleString("zh-CN",{minimumFractionDigits:2,maximumFractionDigits:2})}const $=C(()=>{if(!B.value||!Y.value.size)return[];const t=new Set,e=[];for(const a of M.value){if(a.remDays===null||a.remDays>90)continue;const r=gt(a.mat);if(r.length===0)continue;const i=`${a.mat}-${a.batch}`;t.has(i)||(t.add(i),e.push({mat:a.mat,sku:a.sku,batch:a.batch,category:a.category,expDate:a.expDate,remDays:a.remDays,endQty:a.endQty,endAmt:a.endAmt,flavors:r,state:Z(a.remDays)}))}return e.sort((a,r)=>{const i=a.remDays??9999,o=r.remDays??9999;return i-o||r.endAmt-a.endAmt})}),E=C(()=>{const t=[{id:"risk",label:"库存风险"},{id:"stagnant",label:"库存积压"},{id:"replenishment",label:"报废预警"}];return z.value==="raw"&&t.push({id:"flavorWarning",label:"临期物料耗用预警"}),t}),tt=C(()=>E.value.findIndex(t=>t.id===h.value));let x,k,L,O,Q="";const j=[],{sourceUrl:et,initialize:wt,setMaterialType:Dt,dispose:St}=Jt({initialMaterialType:H(W.params.type)}),Et={已过期:t=>t.remDays!==null&&t.remDays<0,"0-30天":t=>t.remDays!==null&&t.remDays>=0&&t.remDays<=30,"31-90天":t=>t.remDays!==null&&t.remDays>=31&&t.remDays<=90,"91-180天":t=>t.remDays!==null&&t.remDays>=91&&t.remDays<=180,"181-365天":t=>t.remDays!==null&&t.remDays>=181&&t.remDays<=365,"1年以上":t=>t.remDays!==null&&t.remDays>365};function at(t){return new Intl.NumberFormat("zh-CN",{maximumFractionDigits:2}).format(t||0)}function nt(t){return new Intl.NumberFormat("zh-CN",{minimumFractionDigits:2,maximumFractionDigits:2}).format(t||0)}function _t(t){return t===null?"is-neutral":t<0?"is-expired":t<=30?"is-critical":t<=90?"is-warning":"is-normal"}function _(){var t;return(t=y.value)==null?void 0:t.contentWindow}function rt(t){return t<=0?t:Math.max(Math.round(t*J),Math.ceil(t+1))}function it(t){return t.replace(/(\d+(?:\.\d+)?)px/g,(e,a)=>`${rt(Number(a))}px`)}function ot(t){Array.from(t).forEach(e=>{if(e.type===CSSRule.STYLE_RULE){const r=e.style;r.fontSize&&(r.fontSize=it(r.fontSize))}const a=e.cssRules;a&&ot(a)})}function Ct(t){const e=t.documentElement;e.dataset.systemFontScaleApplied!==String(J)&&(Array.from(t.styleSheets).forEach(a=>{try{ot(a.cssRules)}catch{}}),t.querySelectorAll("[style]").forEach(a=>{a.style.fontSize&&(a.style.fontSize=it(a.style.fontSize))}),e.dataset.systemFontScaleApplied=String(J))}function I(t,e="",a=new WeakMap){if(typeof t=="number"&&e==="fontSize")return rt(t);if(!t||typeof t!="object")return t;if(a.has(t))return a.get(t);if(Array.isArray(t)){const i=[];return a.set(t,i),t.forEach(o=>i.push(I(o,"",a))),i}const r={};return a.set(t,r),Object.entries(t).forEach(([i,o])=>{r[i]=I(o,i,a)}),r}function st(t){var r;if(t.__systemFontScaleApplied||!t.setOption)return;const e=t.setOption.bind(t);t.setOption=(i,...o)=>{e(I(i),...o)},t.__systemFontScaleApplied=!0;const a=(r=t.getOption)==null?void 0:r.call(t);a&&e(I(a))}function lt(t){var a;const e=(a=_())==null?void 0:a.echarts;if(e){if(!e.__systemFontScaleApplied&&e.init){const r=e.init.bind(e);e.init=(...i)=>{const o=r(...i);return st(o),o},e.__systemFontScaleApplied=!0}t.querySelectorAll(".chart-box").forEach(r=>{const i=e.getInstanceByDom(r);i&&st(i)})}}function ct(){const t=_();if(!t)return[];try{return t.eval("getView()")}catch{return[]}}function At(t,e,a){const r=[...a].sort((i,o)=>i.remDays===null?1:o.remDays===null?-1:i.remDays-o.remDays);p.value={title:t,description:e,rows:r,totalQuantity:r.reduce((i,o)=>i+(o.endQty||0),0),totalAmount:r.reduce((i,o)=>i+(o.endAmt||0),0)},Xt(()=>{var i;return(i=R.value)==null?void 0:i.focus()})}function U(){p.value=null}function q(t,e,a,r){var f,w,P;const i=t.getElementById(e),o=i&&((w=(f=_())==null?void 0:f.echarts)==null?void 0:w.getInstanceByDom(i));if(!i||!o)return;i.classList.add("drillable-chart");const l=(P=i.closest(".card"))==null?void 0:P.querySelector(".card-title");if(l&&!l.querySelector(".drill-hint")){const b=t.createElement("span");b.className="drill-hint",b.textContent="点击图形查看明细",l.appendChild(b)}const m=b=>{const N=r(b,ct());At(a,N.description,N.rows)};o.on("click",m),j.push(()=>o.off("click",m))}function Ft(t){j.splice(0).forEach(e=>e()),q(t,"chart-expiry","效期区间批次明细",(e,a)=>{const r=Et[e.name]??(()=>!1);return{description:`效期区间：${e.name} · 数据继承当前页面筛选条件`,rows:a.filter(r)}}),q(t,"chart-warehouse","零耗用物料明细",(e,a)=>({description:`品类：${e.name} · 实际耗用量为 0`,rows:a.filter(r=>r.category===e.name&&r.consume===0)})),q(t,"chart-category","品类风险批次明细",(e,a)=>{var o;const r=_();let i="";try{const l=r==null?void 0:r.eval("computeCategory(getView())");i=((o=l==null?void 0:l[e.dataIndex])==null?void 0:o.category)??""}catch{i=e.name.split(" ")[0]}return{description:`品类：${i} · 临期及过期批次（剩余天数 ≤ 90 天）`,rows:a.filter(l=>l.category===i&&l.remDays!==null&&l.remDays<=90)}}),q(t,"chart-supplier","供应商风险批次明细",(e,a)=>({description:`供应商：${e.name} · 临期及过期批次（剩余天数 ≤ 90 天）`,rows:a.filter(r=>r.supplier===e.name&&r.remDays!==null&&r.remDays<=90)}))}const Bt={risk:[".dashboard > .charts-row"],stagnant:[".dashboard > .rank-row"],replenishment:[".dashboard > section.card:not(.rules-row)",".dashboard > .rules-row"],flavorWarning:[]},Lt=[".dashboard > .charts-row",".dashboard > .rank-row",".dashboard > section.card:not(.rules-row)",".dashboard > .rules-row"].join(", ");function V(){L&&(window.clearTimeout(O),O=window.setTimeout(()=>{if(!L)return;const t=h.value==="flavorWarning"?60:1200;A.value=Math.max(t,Math.ceil(L.scrollHeight)+2)},40))}function Nt(t){var a;const e=(a=_())==null?void 0:a.echarts;e&&t.querySelectorAll(".chart-box").forEach(r=>{var i,o;r.offsetParent!==null&&((o=(i=e.getInstanceByDom(r))==null?void 0:i.resize)==null||o.call(i))})}function Tt(t,e){const a=t.querySelector(".system-batch-pagination");if(a)return a;e.id||(e.id="embedded-expiry-dashboard");const r=t.createElement("nav");r.className="system-batch-pagination",r.setAttribute("aria-label","批次与效期预警页面");const i=t.createElement("div");i.className="system-batch-tab-list",i.setAttribute("role","tablist"),E.value.forEach((w,P)=>{const b=t.createElement("button"),N=t.createElement("span");b.id=`embedded-batch-tab-${w.id}`,b.type="button",b.dataset.dashboardView=w.id,b.setAttribute("role","tab"),b.setAttribute("aria-controls",e.id),N.textContent=String(P+1).padStart(2,"0"),b.append(N,t.createTextNode(w.label)),b.addEventListener("click",()=>ut(w.id)),i.appendChild(b)});const o=t.createElement("div");o.className="system-batch-page-controls";const l=t.createElement("span");l.dataset.pageStatus="true";const m=t.createElement("button");m.type="button",m.dataset.pageDirection="previous",m.setAttribute("aria-label","上一页"),m.textContent="←",m.addEventListener("click",()=>pt(-1));const f=t.createElement("button");return f.type="button",f.dataset.pageDirection="next",f.setAttribute("aria-label","下一页"),f.textContent="→",f.addEventListener("click",()=>pt(1)),o.append(l,m,f),r.append(i,o),r}function zt(t,e){const a=e.querySelector(":scope > .kpi-row"),r=e.querySelector(":scope > .header"),i=e.querySelector(":scope > .upload-hint"),o=Tt(t,e);let l=null;a&&(e.insertBefore(a,e.firstElementChild),l=a),[r,i,o].forEach(m=>{m&&(l?l.after(m):e.insertBefore(m,e.firstElementChild),l=m)})}function Mt(t){const e=tt.value;t.querySelectorAll("[data-dashboard-view]").forEach(o=>{const l=o.dataset.dashboardView===h.value;o.classList.toggle("active",l),o.setAttribute("aria-selected",String(l)),o.tabIndex=l?0:-1});const a=t.querySelector("[data-page-status]");a&&(a.textContent=`${String(e+1).padStart(2,"0")} / ${String(E.value.length).padStart(2,"0")}`);const r=t.querySelector('[data-page-direction="previous"]'),i=t.querySelector('[data-page-direction="next"]');r&&(r.disabled=e===0),i&&(i.disabled=e===E.value.length-1)}function dt(t){t.querySelectorAll(Lt).forEach(e=>{e.classList.add("system-pagination-hidden"),e.setAttribute("aria-hidden","true")}),Bt[h.value].forEach(e=>{t.querySelectorAll(e).forEach(a=>{a.classList.remove("system-pagination-hidden"),a.setAttribute("aria-hidden","false")})}),t.documentElement.dataset.systemDashboardView=h.value,Mt(t),requestAnimationFrame(()=>{Nt(t),V()})}function ut(t){var a;if(h.value===t)return;h.value=t;const e=(a=y.value)==null?void 0:a.contentDocument;e&&dt(e)}function pt(t){const e=tt.value+t,a=E.value[e];a&&ut(a.id)}function $t(){var i,o,l,m;u.value=!1;const t=ct();S.value=t.length,M.value=t,Yt(M.value);const e=(i=y.value)==null?void 0:i.contentDocument;if(!e)return;if(!e.getElementById("system-minimal-theme")){const f=e.createElement("style");f.id="system-minimal-theme",f.textContent=ze,e.head.appendChild(f)}Ct(e),lt(e),(l=(o=_())==null?void 0:o.renderAll)==null||l.call(o),lt(e),Ft(e);const a=e.querySelector(".dashboard > section.card:not(.rules-row)");(m=a==null?void 0:a.lastElementChild)==null||m.classList.add("batch-detail-scroll");const r=e.querySelector(".dashboard");r&&(L=r,zt(e,r),dt(e),x==null||x.disconnect(),k==null||k.disconnect(),x=new ResizeObserver(V),k=new MutationObserver(V),x.observe(r),k.observe(r,{childList:!0,subtree:!0,characterData:!0}),requestAnimationFrame(V))}function It(){u.value=!1,S.value=0,M.value=[]}function mt(t){t.key==="Escape"&&p.value&&U()}return K(p,t=>{t?(Q=document.body.style.overflow,document.body.style.overflow="hidden"):document.body.style.overflow=Q}),K(()=>W.params.type,t=>{const e=H(t);z.value!==e&&(z.value=e,u.value=!0,S.value=0,p.value=null,Dt(e))}),K(E,t=>{t.some(e=>e.id===h.value)||(h.value="risk")}),Vt(()=>{wt(),yt(),document.documentElement.classList.add("batch-bento-active"),window.addEventListener("keydown",mt)}),Pt(()=>{St(),j.splice(0).forEach(t=>t()),x==null||x.disconnect(),k==null||k.disconnect(),L=void 0,window.clearTimeout(O),window.removeEventListener("keydown",mt),document.body.style.overflow=Q,document.documentElement.classList.remove("batch-bento-active")}),(t,e)=>(c(),d(T,null,[n("div",oe,[n("div",se,[u.value?(c(),d("div",le,"正在载入"+s(F.value)+"批次与效期预警看板...",1)):D("",!0),ht(et)?(c(),d("iframe",{key:1,id:"expiry-dashboard-frame",ref_key:"dashboardFrame",ref:y,class:"expiry-dashboard-frame",src:ht(et),title:`${F.value}批次与效期预警看板`,scrolling:"no",style:Rt({height:`${A.value}px`}),onLoad:$t,onError:It},null,44,ce)):D("",!0)]),h.value==="flavorWarning"?(c(),d("section",de,[ft.value.isCustom?(c(),d(T,{key:1},[n("div",pe,[n("div",null,[n("h2",null,"临期"+s(F.value)+"耗用预警",1)]),$.value.length?(c(),d("span",me,s($.value.length)+" 条临期"+s(F.value)+"可在 BOM 配方中耗用 · 按剩余天数升序 ",1)):D("",!0)]),$.value.length?(c(),d("div",be,[n("table",fe,[e[1]||(e[1]=n("thead",null,[n("tr",null,[n("th",null,"物料"),n("th",null,"批次"),n("th",{class:"number-cell"},"库存数量"),n("th",{class:"number-cell"},"库存金额"),n("th",null,"到期日期"),n("th",null,"剩余天数"),n("th",null,"效期状态"),n("th",null,"可耗用口味")])],-1)),n("tbody",null,[(c(!0),d(T,null,X($.value,(a,r)=>(c(),d("tr",{key:`${a.mat}-${a.batch}-${r}`},[n("td",ge,[n("strong",null,s(a.sku||"未标注物料"),1),n("span",null,s(a.mat),1)]),n("td",null,s(a.batch||"—"),1),n("td",ye,s(xt(a.endQty)),1),n("td",ve,s(kt(a.endAmt))+" 万元",1),n("td",null,[n("strong",null,s(a.expDate||"未标注"),1)]),n("td",null,[n("span",{class:G(["rem-days-badge",a.state])},s(a.remDays!==null?`${a.remDays} 天`:"—"),3)]),n("td",null,[n("span",{class:G(["expiry-status-badge",a.state])},s(vt(a.remDays)),3)]),n("td",xe,[a.flavors.length?D("",!0):(c(),d("span",ke,"—")),(c(!0),d(T,null,X(a.flavors,i=>(c(),d("span",{key:i.flavor,class:"flavor-tag",title:i.blendingName?`调配液：${i.blendingName}`:""},s(i.flavor),9,we))),128))])]))),128))])])])):(c(),d("div",he,[n("p",null,"暂无临期"+s(F.value)+"可在 BOM 配方中耗用",1)]))],64)):(c(),d("div",ue,[...e[0]||(e[0]=[n("p",null,"请先上传 BOM 文件，系统将自动匹配临期原料的可耗用口味",-1)])]))])):D("",!0)]),(c(),Wt(jt,{to:"body"},[Ht(Qt,{name:"detail-dialog"},{default:Ot(()=>[p.value?(c(),d("div",{key:0,class:"detail-dialog-backdrop",role:"presentation",onMousedown:Kt(U,["self"])},[n("section",{class:"detail-dialog",role:"dialog","aria-modal":"true","aria-labelledby":bt},[n("header",De,[n("div",null,[e[2]||(e[2]=n("p",{class:"detail-dialog-eyebrow"},"CHART DETAIL · 图表下钻",-1)),n("h2",{id:bt},s(p.value.title),1),n("p",null,s(p.value.description),1)]),n("button",{ref_key:"dialogCloseButton",ref:R,type:"button",class:"detail-dialog-close","aria-label":"关闭明细弹窗",onClick:U}," × ",512)]),n("div",Se,[n("div",null,[e[3]||(e[3]=n("span",null,"命中记录",-1)),n("strong",null,s(p.value.rows.length),1),e[4]||(e[4]=n("small",null,"条",-1))]),n("div",null,[e[5]||(e[5]=n("span",null,"库存数量",-1)),n("strong",null,s(at(p.value.totalQuantity)),1),e[6]||(e[6]=n("small",null,"KG",-1))]),n("div",null,[e[7]||(e[7]=n("span",null,"库存金额",-1)),n("strong",null,s(nt(p.value.totalAmount)),1),e[8]||(e[8]=n("small",null,"元",-1))])]),n("div",Ee,[n("table",_e,[e[10]||(e[10]=n("thead",null,[n("tr",null,[n("th",null,"物料编码"),n("th",null,"物料描述"),n("th",null,"批次"),n("th",null,"品类"),n("th",null,"供应商"),n("th",{class:"number-cell"},"库存数量"),n("th",{class:"number-cell"},"库存金额"),n("th",null,"生产日期"),n("th",null,"到期日期"),n("th",{class:"number-cell"},"剩余天数"),n("th",null,"建议动作")])],-1)),n("tbody",null,[(c(!0),d(T,null,X(p.value.rows,(a,r)=>(c(),d("tr",{key:`${a.mat}-${a.batch}-${r}`},[n("td",Ce,s(a.mat||"—"),1),n("td",Ae,s(a.sku||"—"),1),n("td",Fe,s(a.batch||"—"),1),n("td",null,s(a.category||"未知"),1),n("td",null,s(a.supplier||"未知"),1),n("td",Be,s(at(a.endQty)),1),n("td",Le,s(nt(a.endAmt)),1),n("td",null,s(a.prodDate||"—"),1),n("td",null,s(a.expDate||"—"),1),n("td",Ne,[n("span",{class:G(["days-value",_t(a.remDays)])},s(a.remDays??"—"),3)]),n("td",null,s(a.action||"—"),1)]))),128)),p.value.rows.length===0?(c(),d("tr",Te,[...e[9]||(e[9]=[n("td",{colspan:"11",class:"detail-empty"},"当前条件下没有可显示的批次明细",-1)])])):D("",!0)])])])])],32)):D("",!0)]),_:1})]))],64))}}),Re=te(Me,[["__scopeId","data-v-a4ed06b6"]]);export{Re as default};
