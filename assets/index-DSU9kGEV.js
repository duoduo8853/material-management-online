import{d as Et,s as At,f as Ct,g as _t,o as f,c as y,a as o,x as et,h as m,i as T,z as It,m as Lt,A as Ft,B as qt,T as Tt,F as at,r as x,w as zt,t as c,j as Bt,n as Vt,p as Nt,q as $t}from"./index-CA7iFneF.js";import{W as Mt}from"./WorkbookImportPanel-BIvKQ5MC.js";import{d as Rt,u as Wt}from"./useInventoryWorkbookSource-DNgDdu1z.js";import{_ as Pt}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./businessDataStore-KowC_G3t.js";const jt={class:"page-container expiry-dashboard-page"},Ht={class:"dashboard-frame-shell"},Ot={key:0,class:"frame-loading"},Qt=["src"],Ut={class:"detail-dialog-header"},Kt={class:"detail-dialog-summary"},Xt={class:"detail-dialog-table-wrap"},Gt={class:"detail-dialog-table"},Yt={class:"code-cell"},Jt={class:"material-cell"},Zt={class:"code-cell"},te={class:"number-cell"},ee={class:"number-cell"},ae={class:"number-cell"},re={key:0},rt="chart-detail-dialog-title",$=1.1,ne=`
  :root {
