import{d as ut,q as pt,f as mt,g as ht,o as p,c as h,a as r,F as T,h as J,n as X,t as l,j as bt,i as L,x as ft,l as gt,y as yt,z as kt,A as xt,T as wt,r as g,m as vt,w as Dt,p as _t}from"./index-UJ0J2zJq.js";import{_ as St}from"./_plugin-vue_export-helper-DlAUqK2U.js";const Ct={class:"page-container expiry-dashboard-page"},Et={class:"batch-pagination","aria-label":"批次与效期预警页面"},At={class:"batch-tab-list",role:"tablist"},Ft=["id","aria-selected","onClick"],Tt={class:"batch-page-controls"},Lt=["disabled"],Vt=["disabled"],It={class:"dashboard-frame-shell"},zt={key:0,class:"frame-loading"},$t={class:"detail-dialog-header"},qt={class:"detail-dialog-summary"},Bt={class:"detail-dialog-table-wrap"},Nt={class:"detail-dialog-table"},Mt={class:"code-cell"},Rt={class:"material-cell"},jt={class:"code-cell"},Ht={class:"number-cell"},Ot={class:"number-cell"},Qt={class:"number-cell"},Pt={key:0},Z="chart-detail-dialog-title",V=1.1,Ut=`
  :root {
