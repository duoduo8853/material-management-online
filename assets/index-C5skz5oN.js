import{d as Et,r as m,g as R,f as Ct,h as _t,o as g,c as x,a as o,t as d,k as T,j as it,B as At,y as Lt,i as Tt,C as qt,D as Bt,T as Ft,F as st,J as zt,z as j,w as It,m as Vt,p as Mt,n as Nt,u as $t}from"./index-laAt3lBv.js";import{u as Rt,e as jt}from"./useInventoryWorkbookSource-BwR30PN-.js";import{_ as Ht}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./xlsx-CuKvrqns.js";import"./businessDataStore-Bz5EoNTU.js";const Ot={class:"page-container expiry-dashboard-page"},Pt={class:"dashboard-frame-shell"},Qt={key:0,class:"frame-loading"},Ut=["src","title"],Wt={class:"detail-dialog-header"},Kt={class:"detail-dialog-summary"},Xt={class:"detail-dialog-table-wrap"},Gt={class:"detail-dialog-table"},Jt={class:"code-cell"},Yt={class:"material-cell"},Zt={class:"code-cell"},te={class:"number-cell"},ee={class:"number-cell"},ae={class:"number-cell"},re={key:0},lt="chart-detail-dialog-title",H=1.1,ne=`
  :root {
