import{d as ne,r as k,g as et,f as re,h as oe,o as p,c as m,a as n,z as kt,i as E,t as s,j as D,B as ie,F as P,k as at,m as nt,x as se,C as le,D as ce,T as de,J as ue,y as $,w as pe,n as me,u as he}from"./index-CVvZdsYl.js";import{W as fe}from"./WorkbookImportPanel-RjIhXMbv.js";import{u as be,d as ge,e as ye}from"./useInventoryWorkbookSource-BE-m82Si.js";import{r as ve,u as xe}from"./xlsx-CuKvrqns.js";import{g as we,r as ke,n as Dt,s as Se}from"./businessDataStore-BwGRYbGU.js";import{_ as De}from"./_plugin-vue_export-helper-DlAUqK2U.js";function F(u){return String(u??"").replace(/\s+/g," ").trim()}function _t(u){let l=F(u);return l?(l=l.replace(/^(PET瓶|HDPE瓶|PP瓶|PET|HDPE|TP|PP|PC|PE|瓶)/i,""),l=l.replace(/[（(].*$/,""),l=l.replace(/(调配液|浓缩液|原浆|糖浆|调配|浓缩|液)$/i,""),l.trim()):""}const _e={blendingCode:["调配液料号","调配液编码","调配液代码","BOM表头物料","表头物料"],blendingName:["调配液","调配液名称","调配液描述","BOM表头物料名称","表头物料名称"],materialCode:["物料","物料编码","物料号","料号","BOM组件料号"],materialName:["物料描述","物料名称","BOM组件名称","组件名称"],flavor:["口味","风味","产品口味","品味"]};function G(u){return F(u).toLocaleLowerCase("zh-CN").replace(/[（）()【】[\]·:：/\\_\-\s]/g,"")}function Ee(u){const l=u.map(G),h={};return Object.entries(_e).forEach(([S,f])=>{const c=f.map(G),b=l.findIndex(g=>c.includes(g));b>=0&&(h[S]=b)}),h}function Ce(u){const l=ve(u,{type:"array",cellDates:!0}),h=[];return l.SheetNames.forEach(S=>{if(!S.includes("调配液"))return;const f=l.Sheets[S];if(!f)return;const c=xe.sheet_to_json(f,{header:1,defval:"",raw:!1});let b=null;for(let g=0;g<Math.min(c.length,20);g++){const v=Ee(c[g]);if(v.materialCode!==void 0&&(v.flavor!==void 0||v.blendingName!==void 0)){b=v;break}}if(b)for(let g=0;g<c.length;g++){const v=c[g];if(b.materialCode===void 0)continue;const B=F(v[b.materialCode]);if(!B||G(B)===G("物料"))continue;const N=b.blendingName!==void 0?F(v[b.blendingName]):"",_=(b.flavor!==void 0?F(v[b.flavor]):"")||_t(N);h.push({blendingCode:b.blendingCode!==void 0?F(v[b.blendingCode]):"",blendingName:N,materialCode:B,materialName:b.materialName!==void 0?F(v[b.materialName]):"",flavor:_})}}),h}function Ae(u){const l=new Map;return u.forEach(h=>{if(!h.materialCode)return;const S=h.flavor||_t(h.blendingName);if(!S)return;const f=l.get(h.materialCode)||[],c={flavor:S,blendingName:h.blendingName};f.some(g=>g.flavor===c.flavor&&g.blendingName===c.blendingName)||f.push(c),l.set(h.materialCode,f)}),l}async function Be(u){if(!/\.xlsx?$/i.test(u.name))throw new Error("请选择 XLS 或 XLSX 格式的 BOM 文件");const l=Ce(await u.arrayBuffer());if(!l.length)throw new Error('BOM 文件中没有找到有效记录，请检查是否包含"物料"列以及"口味"或"调配液"列');const h={kind:"bom",fileName:u.name,updatedAt:new Date().toISOString(),records:l};return await Se(h),Dt("bom"),h}function Ne(){return we("bom")}async function Ie(){await ke("bom"),Dt("bom")}function Fe(u){return u?{fileName:u.fileName,updatedAt:u.updatedAt,rowCount:u.records.length,isCustom:!0}:{fileName:"",updatedAt:"",rowCount:0,isCustom:!1}}const Me={class:"page-container expiry-dashboard-page"},Le={class:"data-source-row"},Te={class:"bom-panel"},ze={class:"bom-panel-info"},$e={key:0},qe={key:1,class:"bom-error"},Oe={class:"bom-panel-actions"},Pe=["disabled"],Ve={class:"dashboard-frame-shell"},Re={key:0,class:"frame-loading"},We=["src","title"],He={key:0,class:"flavor-warning-panel"},je={key:0,class:"flavor-warning-empty"},Qe={class:"flavor-warning-heading"},Ue={key:0,class:"flavor-warning-meta"},Xe={key:0,class:"flavor-warning-empty"},Ke={key:1,class:"flavor-warning-table-wrap"},Ge={class:"flavor-warning-table"},Je={class:"flavor-material-cell"},Ye={class:"number-cell"},Ze={class:"number-cell"},ta={class:"flavor-cell"},ea={key:0,class:"flavor-empty"},aa=["title"],na={class:"detail-dialog-header"},ra={class:"detail-dialog-summary"},oa={class:"detail-dialog-table-wrap"},ia={class:"detail-dialog-table"},sa={class:"code-cell"},la={class:"material-cell"},ca={class:"code-cell"},da={class:"number-cell"},ua={class:"number-cell"},pa={class:"number-cell"},ma={key:0},St="chart-detail-dialog-title",rt=1.1,ha=`
  :root {
